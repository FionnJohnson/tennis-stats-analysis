# Wimbledon Statistical Analysis (2000 – 2024)

This project explores how the game of tennis has evolved over the past 25 years by analysing men’s Wimbledon semi-final and final matches between 2000 and 2024. 
While this era was mainly dominated by Roger Federer, Rafael Nadal and Novak Djokovic, the focus here is not on individual player performance but how the overall 
game of tennis has changed, particularly in serving and return quality, match length and overall competitiveness.

In the early 2000s, Wimbledon matches played on grass court, was characterised by a serve and volley playstyle leading to shorter rallies and overall quicker 
matches. Since then the playstyle has evolved as well as improvements in racket technology, court surfaces and player athleticism. This change has shifted the
style to longer rallies and baseline play. 


## Average number of aces per year

The first aim was to explore whether the number of aces at Wimbledon has increased over the past 25 years caused by improvements in player power, technique 
and racket technology.

The expectation was that aces would increase over time reflecting more powerful serves and improved tennis equipment. However the graph shows the average
number of aces has fluctuated rather than followed any upward trend. This suggests, the number of aces depends more on the individual players performance
and skill level rather than the evolution of the sport. 
...
some of the lowest double fault averages ever. Since then there has been a slight overall rise in the number of double faults. Overall, it seems that
while serving power may have increased over time, accuracy and consistency has not declined that much.
...
of the players who reached the later rounds.


## Average match length over years

It was expected that as player athleticism improved, along with advances in racket technology and court conditions, the length of matches might increase. 
Overall the graph below (left) shows natural variation in match duration for both semi-finals and finals, but certain years stand out with significantly 
longer matchups:

-	2008 (Federer vs Nadal) – 288 
-	2018 (Anderson vs Isner) – 356 minutes
-	2019 (Federer vs Djokovic) – 297 minutes
...
Many of the longer matches, particularly those involving Federer, Nadal, Djokovic (and Murray) were between evenly matched opponents. In these cases, 
extended rallies and tight scorelines may account for the longer match durations rather than serve quality. 


## Total points played per year

The final statistic explores the average number of total points played in Wimbledon semi-finals and final matches. As expected, this measure closely 
follows the pattern of match duration, since longer matches naturally involve more points. However, not all long matches are due to a greater number 
